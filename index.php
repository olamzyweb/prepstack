...
<head>
    ...
    <title>Past Questions Portal</title>
...
<?php include 'includes/navbar2.php'; ?> 
  ...
  <section class="py-5" id="about">
    <div class="container">
      ...
      <p class="lead">PrepStack offers students ast questions for download at minimal and affordable price</p>
    </div>
  </section>
  ...
  <div class="col-md-4">
    <div class="card question-card">
        <div class="card-body">
            <h5 class="card-title">PHY 102</h5>
            <p class="card-text">Past question for Math 102 (Year: 2022).</p>
...
<div class="col-md-4">
    <div class="card question-card">
        <div class="card-body">
            <h5 class="card-title">BIO 102</h5>
            <p class="card-text">Past question for Math 102 (Year: 2022).</p>
            <a href="catalog.php" class="btn btn-custom">Get Now</a>
        </div>
    </div>
